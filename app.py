...
@app.route('/cmd')
def cmd():
	global status_prova, tempo_limite_prova, tempo_inicio_prova, historico_passagens, relogio_inicial_texto, tipo_sessao, parametro_prova, vencedor_detectado, grid_final_salvo, TABELA_PILOTOS
